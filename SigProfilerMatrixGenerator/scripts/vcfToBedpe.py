...
def vcfToBedpe(vcf_path, output_path):
    ...
    bedpe_out = open(output_path + sample + ".bedpe.tsv", "w")
    ...
    for line in vcf_file:
        ...
        if var.info['SVTYPE'] != 'BND':
            ...
            if len(r.findall(var.alt)) > 0:
                ...
                b2 = int(b2)
            # else:
            #     print(f"No matches found for variant {var.alt}. Skipping.")
            #     continue
    ...
    df = pd.read_csv(output_path + sample + ".bedpe.tsv", sep="\t")
...
manta = "/Users/khandekara2/iCloud/SigProfilerMatrixGenerator/SigProfilerMatrixGenerator/references/SV/example_input/VCF/test.merge.manta.vcf"
delly = "/Users/khandekara2/iCloud/SigProfilerMatrixGenerator/SigProfilerMatrixGenerator/references/SV/example_input/VCF/test.merge.delly.vcf"
lumpy = "/Users/khandekara2/iCloud/SigProfilerMatrixGenerator/SigProfilerMatrixGenerator/references/SV/example_input/VCF/test.merge.lumpy.vcf"
gridss = "/Users/khandekara2/iCloud/SigProfilerMatrixGenerator/SigProfilerMatrixGenerator/references/SV/example_input/VCF/test.merge.gridss.vcf"
gnomad = "/Users/khandekara2/iCloud/SigProfilerMatrixGenerator/SigProfilerMatrixGenerator/references/SV/example_input/VCF/gnomad.v4.0.sv.chr1.vcf"
...
def main():
    ...
    input_path = gridss
    output_path = "/Users/khandekara2/Downloads/gnomad.test.bedpe"

    # call primary function
    #vcfToBedpe(args.input, args.output)
    bedpe = vcfToBedpe(input_path, output_path)
    bedpe.to_csv(output_path, sep="\t", index=None)
    print("Performed conversion of VCF to BEDPE and outputted bedpe file to " + str(output_path))
