...
def parse_args():
    ...
    parser.add_argument("-m", "--maf", dest="maf", help="MAF file from which to extract matrix.")
...
if __name__ == "__main__":
    ...
    matrices = matGen.SigProfilerMatrixGeneratorFunc(args.project, "GRCh37", args.maf, plot=True, exome=False, bed_file=None, chrom_based=False, tsb_stat=False, seqInfo=False, cushion=100)
